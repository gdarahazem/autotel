    ...
    <x-slot name="head">
        <div class="text-center">
            ...
            @if(Route::currentRouteName() == 'login')
                <p>{{ __('messages.dont_have_an_account_yet?') }} <a
                        href="{{ route('register') }}">{{ __('messages.Sign_up_here') }}</a>
                </p>
            @endif
        </div>
    </x-slot>
        ...
        <div class="col-12">
            ...
            <div class="input-group" id="show_hide_password">
                <input type="password" class="form-control border-end-0" id="password" name="password"
                       placeholder="Mot de passe"> <a href="javascript:;" class="input-group-text bg-transparent"><i
        ...
        <div class="col-12">
            <div class="d-grid">
                <button type="submit" class="btn btn-primary"><i
                        class="bx bxs-lock-open"></i>{{ __('messages.Log_in') }}</button>
            </div>
        </div>
