        ...
        <div class="card">
            <div class="row g-0">
                <div class="col-md-4 border-end">
                    <img src="{{asset("assets/images/phones/" . $phone->photos[0]->src)}}" class="img-fluid" alt="...">
                    <div class="row mb-3 row-cols-auto g-2 justify-content-center mt-3">
                        <div class="col">
                            @foreach($phone->photos as $p)
                                <img src="{{asset("assets/images/phones/". $p->src )}}" width="70"
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <div class="mb-3 mt-3">
                            <span class="price h4">{{ $phone->price }} dt</span>
                        </div>
                        <dl class="row">
                            ...
                            <dt class="col-sm-3">Caméra Avant</dt>
                            <dd class="col-sm-9">{{ $phone->front_camera }} MégaPixels</dd>

                            <dt class="col-sm-3">Caméra Arriere</dt>
                            <dd class="col-sm-9">{{ $phone->back_camera }} MégaPixels</dd>
